...
function armarMensajeConfirmacion(plantilla, pedido, moneda) {
  const fechas = pedido.dias > 1 ? `${pedido.fecha_inicio} al ${pedido.fecha_fin} (${pedido.dias} días)` : pedido.fecha_evento || pedido.fecha_inicio;
