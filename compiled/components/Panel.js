...
¿Reactivar?`
  ...
  ), /* @__PURE__ */ React.createElement("small", null, "La clienta la ve al hacer el pedido y en el enlace de su reserva. Si la dejas vacía, no se muestra.")), /* @__PURE__ */ React.createElement("label", { className: "check-linea" }, /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "checkbox",
  ...
  ), " ", "Ofrezco servicio a domicilio (la clienta lo pide, tú coordinas el costo por WhatsApp)"), /* @__PURE__ */ React.createElement("label", null, "Instagram", /* @__PURE__ */ React.createElement(
    "input",
    {
