...
function Panel({ negocioInicial, email }) {
  ...
  const cargarProductos = useCallback(async () => {
    try {
      setProductos(await window.supaGet(
        `alquiler_productos?negocio_id=eq.${negocio.id}&select=id,nombre,descripcion,categoria,precio_dia,cantidad,foto_url,activo,orden&order=orden.asc,creado_en.asc`
      ));
    } catch (e) {
  ...
  return /* @__PURE__ */ React.createElement("main", { className: "admin" }, /* @__PURE__ */ React.createElement("header", { className: "admin-header" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("a", { className: "brand", href: enlaceTienda }, /* @__PURE__ */ React.createElement("span", null, "✦"), " ", negocio.nombre), /* @__PURE__ */ React.createElement("p", null, "Panel del negocio")), /* @__PURE__ */ React.createElement("div", { className: "admin-user" }, /* @__PURE__ */ React.createElement("span", null, email), /* @__PURE__ */ React.createElement("a", { href: "#", onClick: (e) => {
    ...
    ))), /* @__PURE__ */ React.createElement("label", { className: "upload" }, subiendo === producto.id ? "Subiendo foto…" : "Cambiar foto", /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "file",
        accept: "image/*",
  ...
  )), /* @__PURE__ */ React.createElement("label", { className: "wide" }, "Enlace de tu tienda", /* @__PURE__ */ React.createElement(
    "input",
    {
      readOnly: true,
